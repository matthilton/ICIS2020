...
### Research Questions and Aims {data-height=250}

1. Are infants sensitive to kinematic boundary cues?
    + Measuring the electrophysiological response to kinematic boundary cues. 
    + Examining whether the response is similar to that evoked by prosodic boundary cues. 
2. Do the kinematic boundary cues modulate processing of the subsequent action?
    ...
    + We therefore examined whether the kinematic boundary cues modulate action processing, by examining electropsyshiological response to actions that do/do not follow kinematic boundary cues.
...
__12-month-old__ infants (_N_ = 23) from German-speaking households contributed data.
...
- We wanted to bring these recent advances together, by testing whether a boundary in an action sequence evokes a CPS-like positivity already during infancy
...
- The ERP response to kinematic boundary cues is CPS-like, suggesting that the cognitive processes underlying the processing of  kinematic cues are similiar to those involved in the processing of prosodic boundary cues. 
...
- We therefore wanted to test whether kinematic boundary cues affect processing of the actions that form the sequence.
- We compared response to all three actions in the sequence. 
- The kinekmatic boundary cues do not occur until the offset of the second action. 
- If kinematic boundary cues affect action processing, we should therefore find an effect of condition only on actions following the boundary cues (i.e. the final action).
...
- These results indiacte that __each action evoked an Nc-component, except the final action in the no-boundary condition__. 
- The kinemtic boundary cues modulated processing of the subsequent action.
